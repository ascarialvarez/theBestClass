...
class ExamRuleController extends Controller
{
    ...
    public function store(ExamRuleStoreRequest $request)
    {
        try {
            ...
            return back()->with('status', 'La creación de la regla de examen fue exitosa!');
        } catch (\Exception $e) {
    ...
    public function update(Request $request)
    {
        try {
            ...
            return back()->with('status', 'La actualización de la regla de examen se ha realizado con éxito!');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
