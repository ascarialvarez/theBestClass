...
class UserController extends Controller
{
    ...
    public function storeTeacher(TeacherStoreRequest $request)
    {
        try {
            ...
            return back()->with('status', 'La creación del profesor fue un éxito!');
        } catch (\Exception $e) {
    ...
    public function storeStudent(StudentStoreRequest $request)
    {
        try {
            ...
            return back()->with('status', 'La creación de los estudiantes fue un éxito!');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function updateStudent(Request $request) {
        try {
            ...
            return back()->with('status', 'La actualización de los estudiantes fue exitosa!');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
    ...
    public function updateTeacher(Request $request) {
        try {
            ...
            return back()->with('status', 'La actualización del profesorado fue un éxito!');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
