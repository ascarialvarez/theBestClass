...
class GradeRuleController extends Controller
{
    ...
    public function store(GradeRuleStoreRequest $request)
    {
        try {
            ...
            return back()->with('status', 'La creación de la regla del sistema de clasificación fue un éxito!');
        } catch (\Exception $e) {
    ...
    public function destroy(Request $request)
    {
        try {
            ...
            return back()->with('status', '¡La eliminación de la regla del sistema de calificación se ha realizado con éxito!');
        } catch (\Exception $e) {
            return back()->withError($e->getMessage());
        }
    }
