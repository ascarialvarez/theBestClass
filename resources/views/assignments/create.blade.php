            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-file-post"></i> {{__('Create Assignment')}}
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{__('Home')}}</a></li>
                            <li class="breadcrumb-item"><a href="{{url()->previous()}}">{{__('My Courses')}}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{__('Create Assignment')}}C</li>
                        </ol>
                    </nav>
                        ...
                        <div class="col-5">
                            <div class="p-3 border bg-light shadow-sm">
                                <form action="{{route('assignment.store')}}" method="POST"  enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label for="assignment-name" class="form-label">{{__('Assignment Name')}}</label>
                                        <input type="text" class="form-control" id="assignment-name" name="assignment_name" placeholder="Assignment Name" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="assignment-file" class="form-label">{{__('Assignment File')}}</label>
