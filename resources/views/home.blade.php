                    ...
                    <div class="row align-items-md-stretch mt-4">
                        <div class="col">
                            <div class="p-3 text-white bg-dark rounded-3">
                                <h3>{{__('Welcome to theBestClass!')}}</h3>
                        ...
                        <div class="col">
                            <div class="p-3 bg-white border rounded-3" style="height: 100%;">
                                ...
                                <p class="text-end">{{__('with')}} <i class="bi bi-lightning"></i> <a href="https://github.com/ascarialvarez/theBestClass" target="_blank" style="text-decoration: none;">theBestClass</a> <i class="bi bi-lightning"></i>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
