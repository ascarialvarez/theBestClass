...
<div class="container">
    <div class="row justify-content-start">
        ...
        <div class="col-xs-11 col-sm-11 col-md-11 col-lg-10 col-xl-10 col-xxl-10">
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3"><i class="bi bi-distribute-vertical"></i> {{__('Exam History')}}</h1>
                    <div class="row">
                        <div class="col-12">
                            <div class="card border-dark my-3">
                                <div class="card-header bg-transparent border-dark">
                                    <i class="bi bi-diagram-2"></i> {{__('Class 1')}}
                                </div>
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <div class="col fs-4">{{__('Quiz')}} 1</div>
                                                                        <div class="col text-end">Jan 9th 2021 9:00 AM</div>
                                                                    </div>
                                                                    <div class="row text-muted">
                                                                        <div class="col">{{__('Belongs to: First Semester')}}</div>
                                                                        <div class="col text-end">Starts: Jan 9th 2021 - Ends: Jan 15th 2021</div>
                                                                    </div>
                                                                
                                                                <p class="card-text">
                                                                    <span class="badge bg-secondary">{{__('Course: Math')}}</span>
                                                                    <span class="badge bg-dark">{{__('Marks: 100')}}</span>
                                                                    <span class="badge bg-primary">{{__('Category: Quiz')}}</span>
                                                                </p>
                                                                </div>
                                                            </div>
                                                            </div>
