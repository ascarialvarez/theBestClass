            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-person-lines-fill"></i> {{__('Teacher')}}
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="{{route('home')}}">{{__('Home')}}</a></li>
                          <li class="breadcrumb-item"><a href="{{route('teacher.list.show')}}">{{__('Teacher List')}}</a></li>
                            ...
                            <div class="col-sm-4 col-md-3">
                                <div class="card bg-light">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">{{__('Gender')}}: {{$teacher->gender}}</li>
                                        <li class="list-group-item">{{__('Phone')}}: {{$teacher->phone}}</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-sm-8 col-md-9">
                                <div class="p-3 mb-3 border rounded bg-white">
                                    <h6>{{__('Teacher Information')}}</h6>
