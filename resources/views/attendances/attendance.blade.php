...
@section('content')
<link rel="stylesheet" href="{{ asset('css/fullcalendar5.11.0.min.css') }}">
<script src="{{ asset('js/fullcalendar5.11.0.main.min.js') }}"></script>
<script src="{{ asset('https://cdn.jsdelivr.net/npm/fullcalendar@5.11.0/locales/es.js') }}"></script>
<div class="container">
            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-calendar2-week"></i> {{__('View Attendance')}}
                    </h1>

                    <h5><i class="bi bi-person"></i> {{__('Student Name')}}: {{$student->first_name}} {{$student->last_name}}</h5>
                    <div class="row mt-3">
