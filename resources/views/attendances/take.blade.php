            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-calendar2-week"></i> {{__('Take Attendance')}}
                    </h1>

                    @include('session-messages')

                    <h3><i class="bi bi-compass"></i>
                        {{__('Class')}} #{{request()->query('class_name')}}, 
                        ...
                        <div class="col-10 bg-white border p-3 shadow-sm">
                            <form action="{{route('attendances.store')}}" method="POST">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th scope="col"># ID Card Number  DNI</th>
                                ...
                                <div class="mb-4">
                                    <button type="submit" class="btn btn-outline-primary"><i class="bi bi-check2"></i> {{__('Submit')}}</button>
                                </div>
                                @endif
                            </form>
                        </div>
