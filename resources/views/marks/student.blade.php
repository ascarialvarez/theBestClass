            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-cloud-sun"></i> {{__('Course Marks')}}
                    </h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{__('Home')}}</a></li>
                            <li class="breadcrumb-item"><a href="{{url()->previous()}}">{{__('My Courses')}}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{__('Course Marks')}}</li>
                        </ol>
                    </nav>
                    <h5>{{__('Course:')}} {{$course_name}}</h5>
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">{{__('Grade Points')}}</th>
