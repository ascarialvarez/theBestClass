            ...
            <div class="row pt-2">
                <div class="col ps-4">
                    <h1 class="display-6 mb-3">
                        <i class="bi bi-cloud-sun"></i> {{__('Give Final Marks')}}
                    </h1>
                    @include('session-messages')
                    <h5><i class="bi bi-diagram-2"></i> {{__('Class')}} {{$class_name}}, {{__('Section')}} #{{$section_name}}</h5>
                    <h5><i class="bi bi-compass"></i> {{__('Course:')}} {{$course_name}}</h5>
                                    ...
                                    <table class="table table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">{{__('Calculated Marks')}}</th>
                                                <th scope="col">{{__('Final Marks')}}</th>
